    ...
    <section id="contact" className="py-16">
      ...
      <div className="max-w-2xl mx-auto bg-white p-8 rounded-xl shadow-lg text-center">
        <p className="text-lg text-gray-600 mb-8">
          I'm currently open to new opportunities and collaborations. If you have a project in mind,
          want to discuss web dev or programming, or just want to say hello, feel free to reach out!
        </p>
